...
async function createTablesForSqlite() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      mode TEXT NOT NULL,
      current_codex_account_id TEXT NULL,
      current_claude_account_id TEXT NULL,
...
async function createTablesForMysql() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      current_codex_account_id VARCHAR(64) NULL,
      current_claude_account_id VARCHAR(64) NULL,
...
async function seedSettings() {
  ...
  await pool.execute(
    `INSERT INTO settings (
      ...
      auto_launch, auto_token_refresh, token_refresh_interval_hours, updated_at
    ...
    [
      ...
      defaultSettings.current_codex_account_id,
      defaultSettings.current_claude_account_id,
...
async function migrateSettings() {
  const migrations = [
    ...
    ['settings', 'current_codex_account_id', 'current_codex_account_id TEXT NULL'],
    ['settings', 'current_claude_account_id', 'current_claude_account_id TEXT NULL'],
    ...
    ['accounts', 'api_model_options', 'api_model_options TEXT NULL'],
